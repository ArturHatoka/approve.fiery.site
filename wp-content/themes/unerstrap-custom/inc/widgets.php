...
class Cities extends WP_Widget {

	public function __construct() {
		$widget_options = array(
			'classname' => 'Cities',
			'description' => 'Вывод городов',
		);
		parent::__construct( 'cities', 'Города', $widget_options );
	}

	public function widget( $args, $instance ) {
		echo $args['before_widget'];
        get_template_part( 'global-templates/cities');
...
function register_cities() {
	register_widget( 'Cities' );
}
add_action( 'widgets_init', 'register_cities' );